...
`/ip 204.152.203.157`", "reply_to_message_id"=> $message_id,
   'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
	...
	apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "Seus créditos acabaram ou o seu plano venceu! Para comprar mais créditos ou renovar o seu plano, chame meu criador: [ @suleiman171 ]. Veja os valores dos créditos e dos planos, logo a baixo.", "reply_to_message_id" => $message_id,
    'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
