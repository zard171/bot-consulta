...
if(!$continuar && !$continuar2){
    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "*Você não tem permissão! Se quiser se tornar um usuário VIP, chame meu criador: [ @suleimanzinhodelasbot ]. Veja os valores dos planos, logo a baixo.*", "reply_to_message_id" => $message_id,
...
curl_setopt_array($curl, array(
	CURLOPT_URL => "https://crew-apis-rest.tech/?token=f15507ddf0f05362a9c8fec3aaff9c521cb11f00&name=CpfHouse&documento=$cpf",
...
*BY:* @testechk12_bot", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                                                                          
                                                      //linha 1
                                                     array(
                                                         array('text'=>'🗑  Apagar  🗑',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'apagar']))//botão com callback                                                   
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
	...
	apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "Seu plano venceu! Para ou renovar o seu plano, chame meu criador: [ @suleiman171 ]. Veja os valores dos planos, logo a baixo.", "reply_to_message_id" => $message_id,
    'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'COMPRAR PARA MIM',"callback_data"=>'vipprivado'), //botão 1
