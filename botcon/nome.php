...
if(!$continuar && !$continuar2){
    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "*Você não tem permissão! Se quiser se tornar um usuário VIP, chame meu criador: [ @suleiman171 ]. Veja os valores dos planos, logo a baixo.*", "reply_to_message_id" => $message_id,
...
curl_setopt_array($curl, array(
	CURLOPT_URL => "http://api.lkzn.tk/api/nome.php?token=9c06b7c4-627e-4b66-8837-f1b82c2c3854&nome=$nome",
...
$titulos
*BY:* @suleimanzinhodelasbot", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                                                                          
                                                      //linha 2
                                                     array(
                                                         array('text'=>'🗑  Apagar  🗑',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'apagar']))//botão com callback                                                   
